...
There were a noticeable bounce near the middle, where $x \rightarrow 50$. It probably results from our sampling data of middle column when contact the whisker from both sides. We shall try to resolve this problem later.
