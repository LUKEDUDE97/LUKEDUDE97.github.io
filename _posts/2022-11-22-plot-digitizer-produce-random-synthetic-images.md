...
![Sample plots of different types](/LocalData/PostPic/2022-11/PlotSamples.PNG){: .shadow width="740"}
...
![bar, scatters and dot-line](/LocalData/PostPic/2022-11/PlotSamples_plt.png){: .shadow width="740"}
...
![DataLoader Pic](/LocalData/PostPic/2022-11/DataLoader.png){: .w-50 .right}
...
![Memory Leakage on ToTensor](/LocalData/PostPic/2022-11/MemoryLeakageOnToTensor.PNG){: .shadow}
...
![Memory Leakage on Numpy](/LocalData/PostPic/2022-11/MemoryLeakageOnNumpy.PNG){: .shadow}
...
![Unzip Barch](/LocalData/PostPic/2022-11/UnZipBatch.png){: .shadow}
_Unzip a Tuple Set_
